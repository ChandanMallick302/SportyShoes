        ...
        <div class="col-sm-3">
          ...
          <div class="col-sm-10 sidenav">
            ...
            <div class="list-group list-group-flush list-group-no-border list-group-sm">
              ...
              <a href="/shop/brand/WoodLand" class="list-group-item list-group-item-action">WoodLand</a>
           ...
           <div class="col-sm-10 sidenav">
            ...
            <div class="list-group list-group-flush list-group-no-border list-group-sm">
              ...
              <a href="/shop/style/Basketball" class="list-group-item list-group-item-action">Basketball</a>
               <a href="/shop/style/Sneakers" class="list-group-item list-group-item-action">Sneakers</a>
            </div>
          </div> 
        </div>
       <div class="col-sm-9">
